...
export const EMOTIONS: Emotion[] = [
  { id: 'e1', label: 'Anxious', emoji: '😟' },
  { id: 'e2', label: 'Angry', emoji: '😤' },
  { id: 'e3', label: 'Sad', emoji: '😢' },
  { id: 'e4', label: 'Empty', emoji: '🫥' },
  { id: 'e5', label: 'Ashamed', emoji: '😞' },
  { id: 'e6', label: 'Lonely', emoji: '🌧️' },
  { id: 'e7', label: 'Rejected', emoji: '💔' },
  { id: 'e8', label: 'Abandoned', emoji: '🫀' },
  { id: 'e9', label: 'Jealous', emoji: '😒' },
  { id: 'e10', label: 'Numb', emoji: '😶' },
  { id: 'e11', label: 'Overwhelmed', emoji: '😵' },
  { id: 'e12', label: 'Calm', emoji: '🌿' },
  { id: 'e13', label: 'Something else', emoji: '✍️' },
];

export const TRIGGERS: Trigger[] = [
  { id: 't1', label: 'Delayed reply', category: 'relationship' },
  { id: 't2', label: 'Tone change', category: 'relationship' },
  { id: 't3', label: 'Feeling ignored', category: 'relationship' },
  { id: 't4', label: 'Criticism', category: 'relationship' },
  { id: 't5', label: 'Conflict', category: 'relationship' },
  { id: 't6', label: 'Shame', category: 'self' },
  { id: 't7', label: 'Loneliness', category: 'situation' },
  { id: 't8', label: 'Sleep', category: 'situation' },
  { id: 't9', label: 'Work/school', category: 'situation' },
  { id: 't10', label: 'Family', category: 'relationship' },
  { id: 't11', label: 'Money', category: 'situation' },
  { id: 't12', label: 'Something else', category: 'other' },
];

export const BODY_SENSATIONS: BodySensation[] = [
  { id: 'b1', label: 'Chest', area: 'chest' },
  { id: 'b2', label: 'Stomach', area: 'stomach' },
  { id: 'b3', label: 'Throat', area: 'throat' },
  { id: 'b4', label: 'Head', area: 'head' },
  { id: 'b5', label: 'Jaw', area: 'jaw' },
  { id: 'b6', label: 'Shoulders', area: 'shoulders' },
  { id: 'b7', label: 'Hands', area: 'hands' },
  { id: 'b8', label: 'Whole body / everywhere', area: 'body' },
  { id: 'b9', label: 'I don’t know', area: 'unknown' },
  { id: 'b10', label: 'Somewhere else', area: 'other' },
];

export const URGES: Urge[] = [
  { id: 'u1', label: 'Text again', risk: 'medium' },
  { id: 'u2', label: 'Call repeatedly', risk: 'medium' },
  { id: 'u3', label: 'Argue', risk: 'medium' },
  { id: 'u4', label: 'Withdraw', risk: 'medium' },
  { id: 'u5', label: 'Apologize too much', risk: 'low' },
  { id: 'u6', label: 'Check social media', risk: 'low' },
  { id: 'u7', label: 'Ask for reassurance', risk: 'low' },
  { id: 'u8', label: 'Spend money', risk: 'medium' },
  { id: 'u9', label: 'Drink/use substances', risk: 'high' },
  { id: 'u10', label: 'End the relationship', risk: 'high' },
  { id: 'u11', label: 'Say something hurtful', risk: 'high' },
  { id: 'u12', label: 'I don’t know', risk: 'low' },
  { id: 'u13', label: 'Something else', risk: 'low' },
];
